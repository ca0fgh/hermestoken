...
func TestMarketplaceUIAPIRoutesAreRegisteredBeforeAuth(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodPost, "/api/marketplace/fixed-orders/1/probe"},
		{http.MethodPost, "/api/marketplace/fixed-orders/1/release"},
		...
		{http.MethodDelete, "/api/marketplace/seller/credentials/1"},
		{http.MethodPost, "/api/marketplace/seller/credentials/1/probe"},
