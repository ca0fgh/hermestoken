...
import (
	...
	_ "github.com/ca0fgh/hermestoken/oauth"
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.DELETE("/referral/subscription/invitees/:invitee_id", controller.DeleteSubscriptionReferralInviteeOverride)
			}
		...
		marketplaceSellerRoute.Use(middleware.UserAuth())
		{
			...
			marketplaceSellerRoute.POST("/:id/probe", middleware.CriticalRateLimit(), controller.SellerProbeMarketplaceCredential)
		...
		marketplaceBuyerRoute.Use(middleware.UserAuth())
		{
			...
			marketplaceBuyerRoute.POST("/fixed-orders/:id/probe", middleware.CriticalRateLimit(), controller.BuyerProbeMarketplaceFixedOrder)
			marketplaceBuyerRoute.POST("/fixed-orders/:id/release", middleware.CriticalRateLimit(), controller.BuyerReleaseMarketplaceFixedOrder)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/logo", controller.UploadLogo)
		...
		// Fork-specific channel routes not covered by upstream's permission-based registration
		channelExtraRoute := apiRouter.Group("/channel")
		channelExtraRoute.Use(middleware.AdminAuth())
		{
			channelExtraRoute.GET("/models_priced", controller.ChannelListPricedModels)
			channelExtraRoute.POST("/codex/oauth/start", controller.StartCodexOAuth)
			channelExtraRoute.POST("/codex/oauth/complete", controller.CompleteCodexOAuth)
			channelExtraRoute.POST("/:id/codex/oauth/start", controller.StartCodexOAuthForChannel)
			channelExtraRoute.POST("/:id/codex/oauth/complete", controller.CompleteCodexOAuthForChannel)
		}
		tokenRoute := apiRouter.Group("/token")
		tokenRoute.Use(middleware.UserAuth())
		{
			tokenRoute.GET("/", controller.GetAllTokens)
			tokenRoute.GET("/groups", controller.GetUserTokenGroups)
