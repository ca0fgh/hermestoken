# HermesToken Electron Desktop App

This directory contains the Electron wrapper for HermesToken, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., hermestoken-macos)
cp ../hermestoken-macos ../hermestoken
```
...
- Store database in `../data/hermestoken.db`
...
### Database Location
- **Development**: `../data/hermestoken.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/HermesToken/data/`
  - Windows: `%APPDATA%/HermesToken/data/`
  - Linux: `~/.config/HermesToken/data/`
