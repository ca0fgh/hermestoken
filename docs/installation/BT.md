...
本文档提供使用宝塔面板 Docker 功能部署 HermesToken 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://github.com/ca0fgh/hermestoken)
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/hermestoken`
...
services:
  hermestoken:
    image: ca0fgh/hermestoken:latest
    container_name: hermestoken
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
```bash
# 拉取最新镜像
docker pull ca0fgh/hermestoken:latest
...
- [官方文档](https://github.com/ca0fgh/hermestoken)
- [环境变量配置](https://github.com/ca0fgh/hermestoken)
- [常见问题](https://github.com/ca0fgh/hermestoken)
- [GitHub 仓库](https://github.com/ca0fgh/hermestoken)
