...
func printHelp() {
	fmt.Println("HermesToken(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: ca0fgh - https://github.com/ca0fgh/hermestoken")
	fmt.Println("Usage: hermestoken [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
