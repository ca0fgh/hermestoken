...
func handlePseudoClaudeStreamChunk(c *gin.Context, info *relaycommon.RelayInfo, claudeInfo *ClaudeResponseInfo, claudeResponse *dto.ClaudeResponse, data string, response *dto.ChatCompletionsStreamResponse) *types.HermesTokenError {
	if claudeResponse == nil {
		return nil
	}
	if info == nil || claudeInfo == nil {
...
func HandleStreamResponseData(c *gin.Context, info *relaycommon.RelayInfo, claudeInfo *ClaudeResponseInfo, data string) *types.HermesTokenError {
...
func ClaudeStreamHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.HermesTokenError) {
...
func HandleClaudeResponseData(c *gin.Context, info *relaycommon.RelayInfo, claudeInfo *ClaudeResponseInfo, httpResp *http.Response, data []byte) *types.HermesTokenError {
	var claudeResponse dto.ClaudeResponse
...
func ClaudeHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.HermesTokenError) {
