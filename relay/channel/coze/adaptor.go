...
import (
	...
	"github.com/ca0fgh/hermestoken/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.HermesTokenError) {
	if info.IsStream {
