...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&TopUp{}, "TopUp"},
		{&CryptoPaymentOrder{}, "CryptoPaymentOrder"},
		{&CryptoPaymentTransaction{}, "CryptoPaymentTransaction"},
		{&CryptoScannerState{}, "CryptoScannerState"},
		{&QuotaData{}, "QuotaData"},
		{&Task{}, "Task"},
		{&TokenVerificationTask{}, "TokenVerificationTask"},
		{&TokenVerificationResult{}, "TokenVerificationResult"},
		{&TokenVerificationReport{}, "TokenVerificationReport"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
...
func migrateReferralRuntimeTables() error {
	...
	for _, item := range referralRuntimeModels {
		if common.UsingMainDatabase(common.DatabaseTypeSQLite) && DB.Migrator().HasTable(item.model) {
			continue
		}
