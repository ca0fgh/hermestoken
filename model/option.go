...
import (
	...
	"github.com/ca0fgh/hermestoken/setting/performance_setting"
...
func InitOptionMap() {
	...
	common.OptionMap["CreemEnabled"] = "true"
	...
	common.OptionMap["TaskModelPricing"] = ratio_setting.TaskModelPricing2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "TaskModelPricing":
		err = ratio_setting.UpdateTaskModelPricingByJSONString(value)
	case "CacheRatio":
	...
	case SubscriptionReferralTeamDecayRatioOptionKey:
