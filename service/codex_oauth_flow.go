...
// Codex OAuth authorization-flow helpers (PKCE authorize + code exchange).
// Restored after the upstream merge dropped them from codex_oauth.go; the
// fork's per-channel Codex OAuth controller depends on these.
