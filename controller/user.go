...
func GetAllUsers(c *gin.Context) {
	...
	if err := model.HydrateWalletQuotaUsage(users); err != nil {
		common.ApiError(c, err)
		return
	}
...
func GetUserModels(c *gin.Context) {
	...
	groups := service.GetUserUsableGroupsForUser(user.Id, user.Group)
	var models []string
...
type UpdateUserSettingRequest struct {
	...
	QuotaTopupEnabled                *bool   `json:"quota_topup_enabled,omitempty"`
}
...
func UpdateUserSetting(c *gin.Context) {
	...
	if req.QuotaTopupEnabled != nil {
		enabled := *req.QuotaTopupEnabled
		settings.QuotaTopupEnabled = &enabled
	}
