...
const homepageNarrativeExpectations = {
  "zh-CN": {
    "AGI 能力流动性基础设施": "AGI 能力流动性基础设施",
    "面向 AGI 能力流动性的基础设施": "面向 AGI 能力流动性的基础设施",
  ...
  "zh-TW": {
    "AGI 能力流动性基础设施": "AGI 能力流動性基礎設施",
    "面向 AGI 能力流动性的基础设施": "面向 AGI 能力流動性的基礎設施",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
      "HermesToken 將異構智能能力抽象為可發現、可組合、可調度、可結算的流動性層。",
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "讓 AGI 在統一供需網絡中獲得連續、可信、可審計的能力供給。",
    能力流动性: "能力流動性",
    供需网络: "供需網絡",
    执行秩序: "執行秩序",
    可信结算: "可信結算",
    ...
    流动网络: "流動網絡",
    "支撑 AGI 的连续能力获取": "支撐 AGI 的連續能力獲取",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "AGI 不再綁定靜態資源，而是在統一供需網絡中按場景獲得持續、穩定的能力供給。",
    执行秩序: "執行秩序",
  ...
  en: {
    "AGI 能力流动性基础设施": "Infrastructure for AGI capability liquidity",
    "面向 AGI 能力流动性的基础设施":
      "Infrastructure for AGI capability liquidity",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
    ...
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "Give AGI continuous, trustworthy, auditable capability supply within a unified supply-demand network.",
    ...
    "支撑 AGI 的连续能力获取":
      "Support continuous capability acquisition for AGI",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "AGI is no longer bound to static resources; it obtains sustained, stable capability supply within a unified supply-demand network.",
    执行秩序: "Execution Order",
  ...
  fr: {
    "AGI 能力流动性基础设施": "Infrastructure de liquidité des capacités AGI",
    "面向 AGI 能力流动性的基础设施":
      "Infrastructure pour la liquidité des capacités AGI",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
    ...
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "Donner aux AGI une offre de capacités continue, fiable et auditée dans un réseau unifié d’offre et de demande.",
    ...
    "支撑 AGI 的连续能力获取":
      "Soutenir l’acquisition continue de capacités pour les AGI",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "Les AGI ne dépendent plus de ressources statiques; ils obtiennent une offre de capacités continue et stable dans un réseau unifié d’offre et de demande.",
    执行秩序: "Ordre d’exécution",
    让能力流动具备确定性:
  ...
  ja: {
    "AGI 能力流动性基础设施": "AGI能力流動性インフラ",
    "面向 AGI 能力流动性的基础设施": "AGI能力流動性のためのインフラ",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
      "HermesTokenは、異なる種類の知的能力を、発見・組成・スケジューリング・決済可能な流動性レイヤーとして抽象化します。",
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "AGI が統一された需給ネットワークの中で、継続的で信頼でき、監査可能な能力供給を得られるようにします。",
    能力流动性: "能力流動性",
    供需网络: "需給ネットワーク",
    执行秩序: "実行秩序",
    可信结算: "信頼できる決済",
    ...
    流动网络: "流動ネットワーク",
    "支撑 AGI 的连续能力获取": "AGI の継続的な能力取得を支える",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "AGI は静的な資源に縛られず、統一された需給ネットワークの中で場面に応じて継続的で安定した能力供給を受けます。",
    执行秩序: "実行秩序",
  ...
  ru: {
    "AGI 能力流动性基础设施": "Инфраструктура ликвидности возможностей AGI",
    "面向 AGI 能力流动性的基础设施":
      "Инфраструктура для ликвидности возможностей AGI",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
    ...
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "Дать AGI непрерывное, доверяемое и аудируемое предложение возможностей в единой сети спроса и предложения.",
    ...
    "支撑 AGI 的连续能力获取":
      "Поддерживать непрерывное получение возможностей для AGI",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "AGI больше не привязан к статическим ресурсам; он получает устойчивое предложение возможностей по сценарию в единой сети спроса и предложения.",
    执行秩序: "Порядок исполнения",
  ...
  vi: {
    "AGI 能力流动性基础设施": "Hạ tầng thanh khoản năng lực AGI",
    "面向 AGI 能力流动性的基础设施": "Hạ tầng cho thanh khoản năng lực AGI",
    "HermesToken 将异构智能能力抽象为可发现、可组合、可调度、可结算的流动性层。":
    ...
    "让 AGI 在统一供需网络中获得连续、可信、可审计的能力供给。":
      "Để AGI có được nguồn cung năng lực liên tục, đáng tin cậy và có thể kiểm toán trong một mạng cung-cầu thống nhất.",
    ...
    "支撑 AGI 的连续能力获取": "Hỗ trợ AGI tiếp nhận năng lực liên tục",
    "AGI 不再绑定静态资源，而是在统一供需网络中按场景获得持续、稳定的能力供给。":
      "AGI không còn bị buộc vào tài nguyên tĩnh; nó nhận nguồn cung năng lực ổn định và liên tục theo ngữ cảnh trong một mạng cung-cầu thống nhất.",
    执行秩序: "Trật tự thực thi",
...
test("default homepage source uses the minimal narrative layout", async () => {
  ...
  assert.ok(source.includes("AGI 能力流动性基础设施"));
