...
// Import each statically-used icon from its own entry point. Importing them
// from the '@lobehub/icons' barrel pulls the whole registry into the bundle
// and defeats the lazy glob below.
...
import MjProxyIcon from '@lobehub/icons/es/Midjourney';
...
export const renderGroupOption = (item) => {
  ...
  const secondaryLabel =
    item.optionDescription || item.fullLabel || item.desc || '';
